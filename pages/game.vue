<template>
    ...
    <div id="unity-container" class="unity-desktop">
			...
			<div class="header">
				<a href="#default" class="logo"><img src="TemplateData/cyberLionzLogoStatic.png" height="32px"> </a>
...
this.mounted(){
      ...
      if (/iPhone|iPad|iPod|Android/i.test(navigator.userAgent)) {
        ...
        //canvas.style.width = window.innerWidth + 'px';
        //canvas.style.height = window.innerWidth / 1.778 + 'px';

        unityShowBanner('CyberLionz WebGL is not fully compatabile with mobile devices - Your experience may vary!');
      } else {
      ...
      canvas.style.background = "url('" + buildUrl + "/Builds.jpg.gz') center / cover";
