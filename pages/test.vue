<template>
	...
	<section class="py-12 bg-white sm:py-16 md:py-20 lg:py-24">
		<div class="max-w-6xl px-8 mx-auto lg:px-16">
			...
			<p class="mb-4 text-sm text-gray-600 sm:text-base md:text-lg">
			...
			<div class="relative mt-2">
				...
				<div
					x-data="{ show: false }"
					class="relative overflow-hidden border-b-2 border-black select-none">
					<h4
						@click="show = !show"
						class="
							flex
					...
					<p
						...
						will also gain access to many other applications and sections of the
						site.
					</p>
				</div>
				...
				<div
					...
					<p
						...
						x-show="show"
						x-cloak="">
						If you need assistance implementing the templates into your project
						you can contact support or you can visit our question section.
					</p>
				</div>
			</div>
		</div>
